        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Giroconto</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body info-card">
                            ...
                            <form method="post" action="assets/includes/checkGiroconto.inc.php">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-11">
                                        <label for="causaleGiroconto" class="form-label">Causale:</label>
                                        <textarea class="form-control mb-4" name="causale" id="causaleGiroconto" cols="10" rows="5"></textarea>
                                    </div>
                                </div>

                                <div class="text-center">
                                    <button type="submit" name="sendGiroconto" class="btn btn-primary">Esegui</button>
                                </div>
                            </form>
