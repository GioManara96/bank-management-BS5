        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Per data</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="row">
                            ...
                            <form method="post" action="" class="w-100">
                                <div class="row justify-content-center align-items-center mb-3">
                                    <div class="col-md-5 col-lg-4">
                                        ...
                                        <input type="date" class="form-control w-auto" id="from" name="from">
                                    </div>

                                    <div class="col-md-5 col-lg-4">
                                        <label for="to">A: </label>
                                        <input type="date" class="form-control w-auto" id="to" name="to">
                                    </div>

                                    <div class="col-md-2 col-lg-4 align-self-end">
                ...
                if (isset($_POST["cerca"])) :
                    ...
                    $sql = "SELECT TMovimentiConto.*, TCategoriaMovimenti.* FROM TMovimentiConto INNER JOIN TCategoriaMovimenti
                        ...
                        $_SESSION["ContoID"] . " AND TMovimentiConto.Data BETWEEN '$from' AND '$to' ORDER BY Data ASC";
