...
<head>
    ...
    <title>Riepilogo Bonifico</title>
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="bonifico.php">Bonifico</a></li>
                    ...
                    <div class="card">
                        <div class="card-body info-card">
                            ...
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <?php
                                    $sql3 = "SELECT * FROM TMovimentiConto WHERE ContoCorrenteID = $idConto AND Stato = 'Non confermato' ORDER BY Data DESC LIMIT 1";
                                    $query3 = mysqli_query($conn, $sql3);
                                    if (mysqli_num_rows($query) === 1) {
                                        $result3 = mysqli_fetch_assoc($query3);
                                        $importo = $_SESSION["importo"] = $result2["Saldo"] - $result3["Saldo"];
                                        $saldoPreventivo = $_SESSION["saldoPreventivo"] = $result3["Saldo"];
                            ...
                            <div class="row align-items-center mb-3">
                                <h6 class="col-md-4 col-lg-3 mb-0">Data di accredito</h6>
                                <div class="col-md-8 col-lg-9">
                                    <p class="mb-0"><?php echo date("d/m/y", strtotime($_SESSION["dataAccredito"])); ?></p>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            ?>
                            <form method="post" action="assets/includes/confermaBonifico.inc.php">
                                <div class="row align-items-center mb-3">
                                    <div class="col-md-8 col-lg-9">
