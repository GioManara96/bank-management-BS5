        ...
        <div class="hero mx-auto p-3 row">
            ...
            <div class="col">
                <div class="istruzioni">
                    ...
                    <p class="px-3">Seconda fase: inserisci il codice di conferma ricevuto via e-mail.</p>
            ...
            <!-- ==== FORM CONFERMA ==== -->
            <div class="col">
                <form action="./assets/includes/conferma.inc.php" method="POST" class="d-flex justify-content-center flex-column p-3">
                    <?php
                    if (isset($_GET["error"])) {
                        switch ($_GET["error"]) {
                            case "badconn":
                    ...
                    ?>
                    <label class="form-label" for="codice">Codice Conferma</label>
