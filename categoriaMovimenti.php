        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Per categoria</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="row">
                            ...
                            <form method="post" action="" class="w-100">
                                <div class="row justify-content-center align-items-center mb-3">
                                    <select name="categoria" class="form-select w-auto">
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM TCategoriaMovimenti";
                                        $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_assoc($query)) {
                                        ?>
                                            <option value="<?php echo $row["CategoriaMovimentoID"]; ?>"><?php echo $row["NomeCategoria"]; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                ...
                if (isset($_POST["cerca"])) :
                    ...
                    $sql = "SELECT TMovimentiConto.*, TCategoriaMovimenti.* FROM TMovimentiConto INNER JOIN TCategoriaMovimenti
                        ...
                        $_SESSION["ContoID"] . " AND TMovimentiConto.CategoriaMovimentoID = $category ORDER BY Data DESC";
                    $query = mysqli_query($conn, $sql);
                    ...
                    <div class="col-xl-8">
                        <div class="card">
                            <div class="card-body pt-3">
                                <table class="table" id="risultati_ricerca">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Data</th>
